...
快速添加在点击“添加”或按回车时执行一次纯规则解析，支持“今天/明天/后天”、“周一”至“周日”、“下周一”至“下周日”，以及“上午9点”、“下午3点”、“晚上8点”、“15:00”、“15点30”等时间。解析器先把注入的当前时间转换到设备本地时区；“上午”保留小时数，“下午”和“晚上”增加 12 小时，因此“下午3点”解析为本地 15:00。只写日期时默认当天 23:59；只写时间且今天该时间已过时取次日同一时间。无法唯一解析或出现重复、具体日期、N 天后等未支持表达式时，整句按普通标题保存。
...
- 旧 JSON 缺少 ID 时自动补全
- 旧字符串数组迁移和损坏记录容错
- 快速添加的相对日期、星期、时间组合、标题清理、保守失败和提醒接入
